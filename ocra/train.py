...
# [GCC 7.2.0]
# Embedded file name: recog.py
# Compiled at: 2017-06-27 15:43:30
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as (session):
        ...
        fw.write('#!MLF!#\r\n')
        model = init_model(session, gpu_id=-1)
		...
		#print(iname)
                ...
                fw.write('"' + rec_path + '"\r\n')
                latin = recog(filename, model, session)
                for lat in latin:
                    fw.write(lat+ ' ')
        ...
        fw.close()
# okay decompiling ProposedRec.pyc
